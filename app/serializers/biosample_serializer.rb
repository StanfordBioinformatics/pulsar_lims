class BiosampleSerializer < ActiveModel::Serializer
  self.root = false
  attributes :id, :control, :date_biosample_taken, :description, :lot_identifier, :name, :notes, :nih_institutional_certification, :part_of_id, :passage_number, :starting_amount, :starting_amount_units, :submitter_comments, :tissue_preservation_method, :tube_label, :vendor_product_identifier, :upstream_identifier, :created_at, :updated_at
