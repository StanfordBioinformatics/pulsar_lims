		...
		def barcode_valid
			...
			if library_paired_end?
				if paired_barcode.present?
					...
					if sequencing_result.barcode_sequencing_results.find_by({library_id: library.id, paired_barcode_id: paired_barcode.id}).present?
				...
				if barcode.present?
					...
					if sequencing_result.barcode_sequencing_results.find_by({library_id: library.id, barcode_id: barcode.id}).present?
