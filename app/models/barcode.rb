class Barcode < ActiveRecord::Base
	DEFINITION = "A single, contiguous barcode sequence that belongs to a Sequencing Library Prep Kit. Can be either an index1 barcode or an index2 barcode in the case of paired-end sequencing."
	has_many :libraries
