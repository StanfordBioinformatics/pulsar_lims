class AntibodiesController < ApplicationController
  ...
  private
    ...
    def antibody_params
      params.require(:antibody).permit(:organism_id, :vendor_id, :isotype_id, :human_target_id, :vendor_product_identifier, :vendor_product_url, :lot_identifier, :clonality, :antigen_description, :antigen_sequence, :name, antibody_purifications_attributes: [:id,:_destroy])
    end
