class AntibodiesController < ApplicationController
  ...
  private
    ...
    def antibody_params
      params.require(:antibody).permit(:organism_id, :antibody_purifications_id, :vendor_id, :isotype_id, :human_gene_id, :vendor_product_identifier, :vendor_product_url, :lot_identifier, :clonality, :antigen_description, :antigen_sequence)
    end
end
