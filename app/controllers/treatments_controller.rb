class TreatmentsController < ApplicationController
  ...
  private
    ...
    def treatment_params
      params.require(:treatment).permit(:upstream, :treatment_term_name_id, :name, :description, :treatment_type, :concentration, :concentration_unit_id, :duration, :duration_units, :temperature, :document_ids => [], :treatment_ids => [])
    end
end
