module LibrariesConcern
  ...
  def add_barcodes(library,barcodes)
    ...
    prep_kit = library.sequencing_library_prep_kit
    barcodes.each do |b| 
      ...
      if library.barcodes.include?(bc)
        next
      end 
      library.barcodes << bc
    end 
	...
	def add_paired_barcodes(library,paired_barcodes)
    ...
    paired_barcodes.each do |b| 
      ...
      if library.paired_barcodes.include?(bc)
        next
      end
      library.paired_barcodes << bc
    end
		return library
	end
