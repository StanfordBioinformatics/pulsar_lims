class LibrariesController < ApplicationController
  ...
  def index
    @records = policy_scope(Library).non_plated_non_prototype.order("lower(name)").page params[:page]
  end
