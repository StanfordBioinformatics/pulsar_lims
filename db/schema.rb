...
ActiveRecord::Schema.define(version: 20190323001926) do
  ...
  create_table "atacseqs", force: :cascade do |t|
    ...
    t.datetime "created_at",                         null: false
    t.datetime "updated_at",                         null: false
    t.boolean  "single_cell",        default: false
  end
  ...
  create_table "biosamples", force: :cascade do |t|
    ...
    t.boolean  "cells_died_after_transfection"
  end
  ...
  create_table "sequencing_results", force: :cascade do |t|
    ...
    t.string   "mapper"
    t.string   "read1_upstream_identifier"
    t.string   "read2_upstream_identifier"
  end
  ...
  add_index "shippings", ["biosample_id", "carrier", "date_shipped", "from_id", "to_id", "tracking_code"], name: "shipping_composite_unique_index", unique: true, using: :btree
