...
RSpec.describe "library_sequencing_results/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit library_sequencing_result form" do
    render

    assert_select "form[action=?][method=?]", library_sequencing_result_path(@library_sequencing_result), "post" do
