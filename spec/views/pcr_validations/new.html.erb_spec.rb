...
RSpec.describe "pcr_validations/new", type: :view do
  before(:each) do
    assign(:pcr_validation, PcrValidation.new(
      :user => nil,
      :description => "MyText",
      :pcr_master_mix => nil,
  ...
  it "renders new pcr_validation form" do
    render

    assert_select "form[action=?][method=?]", pcr_validations_path, "post" do
