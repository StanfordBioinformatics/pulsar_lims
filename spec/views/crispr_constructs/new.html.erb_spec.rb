...
RSpec.describe "crispr_constructs/new", type: :view do
  before(:each) do
    assign(:crispr_construct, CrisprConstruct.new(
      :name => "MyString",
      :user => nil,
      :target => nil,
  ...
  it "renders new crispr_construct form" do
    render

    assert_select "form[action=?][method=?]", crispr_constructs_path, "post" do
