...
RSpec.describe "barcode_sequencing_results/new", type: :view do
  before(:each) do
    assign(:barcode_sequencing_result, BarcodeSequencingResult.new(
      :name => "MyString",
  ...
  it "renders new barcode_sequencing_result form" do
    render

    assert_select "form[action=?][method=?]", barcode_sequencing_results_path, "post" do
