...
RSpec.describe "donor_constructs/new", type: :view do
  before(:each) do
    assign(:donor_construct, DonorConstruct.new(
      :name => "MyString",
      :user => nil,
      :cloning_vector => nil,
      :vender => nil,
  ...
  it "renders new donor_construct form" do
    render

    assert_select "form[action=?][method=?]", donor_constructs_path, "post" do
