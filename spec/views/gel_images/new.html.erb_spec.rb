...
RSpec.describe "gel_images/new", type: :view do
  before(:each) do
    assign(:gel_image, GelImage.new(
      :user => nil,
      :gel => nil,
  ...
  it "renders new gel_image form" do
    render

    assert_select "form[action=?][method=?]", gel_images_path, "post" do
