...
RSpec.describe BarcodesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested barcode as @barcode" do
      barcode = Barcode.create! valid_attributes
      get :show, params: {id: barcode.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested barcode as @barcode" do
      barcode = Barcode.create! valid_attributes
      get :edit, params: {id: barcode.to_param}, session: valid_session
      expect(assigns(:barcode)).to eq(barcode)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Barcode" do
        expect {
          post :create, params: {barcode: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved barcode as @barcode" do
        post :create, params: {barcode: invalid_attributes}, session: valid_session
        expect(assigns(:barcode)).to be_a_new(Barcode)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested barcode" do
        barcode = Barcode.create! valid_attributes
        put :update, params: {id: barcode.to_param, barcode: new_attributes}, session: valid_session
        barcode.reload
      ...
      it "assigns the requested barcode as @barcode" do
        barcode = Barcode.create! valid_attributes
        put :update, params: {id: barcode.to_param, barcode: valid_attributes}, session: valid_session
        expect(assigns(:barcode)).to eq(barcode)
      end
    ...
    context "with invalid params" do
      it "assigns the barcode as @barcode" do
        barcode = Barcode.create! valid_attributes
        put :update, params: {id: barcode.to_param, barcode: invalid_attributes}, session: valid_session
        expect(assigns(:barcode)).to eq(barcode)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested barcode" do
      barcode = Barcode.create! valid_attributes
      expect {
        delete :destroy, params: {id: barcode.to_param}, session: valid_session
      }.to change(Barcode, :count).by(-1)
    end
