...
RSpec.describe ShippingsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created shipping" do
        post :create, {:shipping => valid_attributes}, valid_session
        expect(response).to redirect_to(Shipping.last)
      end
    end

    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, {:shipping => invalid_attributes}, valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested shipping" do
        shipping = Shipping.create! valid_attributes
        put :update, {:id => shipping.to_param, :shipping => new_attributes}, valid_session
        shipping.reload
      ...
      it "redirects to the shipping" do
        ...
        expect(response).to redirect_to(shipping)
      end
    end
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        shipping = Shipping.create! valid_attributes
        put :update, {:id => shipping.to_param, :shipping => invalid_attributes}, valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the shippings list" do
      shipping = Shipping.create! valid_attributes
      delete :destroy, {:id => shipping.to_param}, valid_session
      expect(response).to redirect_to(shippings_url)
    end
  end
